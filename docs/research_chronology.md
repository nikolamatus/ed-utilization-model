...
No research timestamps were invented. Prior message-only cleanup of
tooling trailers did not change file trees or research chronology.
...
| --- | --- | --- |
| 1. Research-plan creation | Researcher recollection: drafted locally before Git existed. Independent calendar date **not established**. | Researcher recollection; uncertain exact date |
...
| --- | --- | --- | --- | --- |
| Analysis-plan drafting outside Git | Researcher recollection | Unknown | Researcher recollection | Do not label post-hoc solely because Git is later. Do not claim a verified prospective date. |
...
Git cannot confirm or refute that recollection. No independently dated
external artifact establishes a plan-creation date. The study should not be called formally preregistered. The plan
